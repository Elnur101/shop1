            ...
            <div class="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
                ...
                <div class="product__view--mode d-flex align-items-center">
                    <div class="product__view--mode__list product__short--by align-items-center d-lg-flex d-none ">
                        <label class="product__view--label">Страница :</label>
                    ...
                    <div class="product__view--mode__list product__short--by align-items-center d-none d-lg-flex">
                        <label class="product__view--label">Сортировать :</label>
                        <div class="select shop__header--select">
                            <select class="product__view--select">
                                @foreach($categories as $category)
                                    <option selected value="1">{{$category->name}}</option>
                                @endforeach
...
{{--                                <option value="4">Sort by  rating </option>--}}
                    ...
                    <div class="product__view--mode__list product__view--search d-xl-block d-none ">
                        <form class="product__view--search__form" action="#">
                            <label>
                                <input class="product__view--search__input border-0" placeholder="Поиск" type="text">
                            </label>
                ...
                <p class="product__showing--count">Показано 1–9 до 21</p>
            </div>
            <div class="row">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        ...
                                        <ul class="widget__categories--sub__menu">
                                            @if($category->children->isNotEmpty())
                                                @include('site.partials.option', ['children'=>$category->children, 'prefix'=>' -- '])
                                            @endif
                                        </ul>
                                    </li>
                                @endforeach
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                <div class="product__items--thumbnail product__list--items__thumbnail">
                                                    <a class="product__items--link" href="product-details.html">
                                                        <img class="product__items--img product__primary--img" src="{{asset('/assets/img/product/product7.png')}}" alt="product-img">
                                            ...
                                            <div class="product__items product__list--items d-flex">
                                                <div class="product__items--thumbnail product__list--items__thumbnail">
                                                    <a class="product__items--link" href="product-details.html">
                                                        ...
                                                        <img class="product__items--img product__secondary--img" src="{{asset('/assets/img/product/product6.png')}}" alt="product-img">
                                                    </a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">Sale</span>
                                                    </div>
