        ...
        <div class="container">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <a class="main__logo--link" href="#"><img class="main__logo--img" src="{{asset('/assets/img/logo/nav-log.png')}}" alt="logo-img"></a>
                </div>
                <div class="header__search--widget d-none d-lg-block header__sticky--none">
                    <form class="d-flex header__search--form" action="#">
                        <div class="header__select--categories select">
                            <select class="header__select--inner">
                                <option selected value="1">Выбрать категории</option>
                        ...
                        <div class="header__search--box">
                            <label>
                                <input class="header__search--input" placeholder="Найти продукт" type="text">
                            </label>
                            <button class="header__search--button bg__secondary text-white" type="submit">Поиск</button>
                        </div>
                    </form>
                </div>
                    ...
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            ...
                            <li class="header__menu--items mega__menu--items">
                                <a class="header__menu--link" href="#">Магазин
                                        ...
                                        <li class="header__mega--menu__li">
                                            ...
                                            <ul class="header__mega--sub__menu">
                                                @if($category->children->isNotEmpty())
                                                    @include('includes-shop.partials.shop2.shop-option', ['children'=>$category->children])
                                                @endif
                                            </ul>
                                        </li>
                                    @endforeach
                            ...
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="#">Страницы</a>

                            </li>
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="#">Contact111 </a>
                            </li>
                        </ul>
                    </nav>
                </div>
                            ...
                            @foreach($categories as $category)
                                <li class="categories__menu--items">
                                    ...
                                    <ul class="categories__submenu border-radius-10 d-flex justify-content-between">
                                        @if($category->children->isNotEmpty())
                                           @include('includes-shop.partials.option', ['children'=>$category->children, 'prefix'=>' - '])
                                        @endif
                                    </ul>
                                </li>
                            @endforeach
                            ...
                            <ul class="category__mobile--menu_ul">
                                ...
                                <li class="categories__menu--items">
                                    ...
                                    <ul class="category__sub--menu">
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="#">Fresh Berries</a>
                                            <ul class="category__sub--menu">
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Apple Juice </a></li>
                                                ...
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">AFresh Seafood </a></li>
                                            </ul>
                                        </li>
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="#">Orange Juice</a>
                                            <ul class="category__sub--menu">
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Apple Juice </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Oil and Vinegar </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Bread and Juice </a></li>
                                        ...
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="#">Fresh Nuts</a>
                                            <ul class="category__sub--menu">
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Apple Juice </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Oil and Vinegar </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Bread and Juice </a></li>
                                        ...
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="#">Laura Mercier</a>
                                            <ul class="category__sub--menu">
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Apple Juice </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Oil and Vinegar </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Bread and Juice </a></li>
                                ...
                                <li class="categories__menu--items">
                                    ...
                                    <ul class="category__sub--menu">
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="#">Hot Offers</a>
                                            <ul class="category__sub--menu">
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Apple Juice </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Oil and Vinegar </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Bread and Juice </a></li>
                                        ...
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="#">Fresh Meat</a>
                                            <ul class="category__sub--menu">
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Apple Juice </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Oil and Vinegar </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Bread and Juice </a></li>
                                        ...
                                        <li class="categories__submenu--items"><a class="categories__submenu--items__text" href="#">Nature Food</a>
                                            <ul class="category__sub--menu">
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Apple Juice </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Oil and Vinegar </a></li>
                                                <li class="categories__submenu--child__items"><a class="categories__submenu--child__items--link" href="#">Bread and Juice </a></li>
                ...
                <div class="header__right--area d-flex justify-content-between align-items-center">
                    <div class="header__menu">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                <li class="header__menu--items">
                                    <a class="header__menu--link text-white" href="#">Главная</a>

                                </li>
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link text-white" href="#">Магазин
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg>
                                    </a>
                                    <ul class="header__mega--menu d-flex">
                                        @foreach($categories as $category)
                                            <li class="header__mega--menu__li">
                                                ...
                                                @if($category->children->isNotEmpty())
                                                    <ul class="header__mega--sub__menu">
                                                        @include('includes-shop.partials.shop2.shop-option', ['children'=>$category->children, 'prefix'=>' - '])
                                                    </ul>
                                                @endif
                                            </li>
                                        @endforeach
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link text-white" href=#>Страницы</a>
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link text-white" href="#">Контакты </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <nav class="offcanvas__menu">
                <ul class="offcanvas__menu_ul">
                    <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="index.html">Главная</a>
                    ...
                    <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="shop.html">Магазин</a>
                        <ul class="offcanvas__sub_menu">
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="{{asset('/assets/img/product/product1.png')}}" alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="{{asset('/assets/img/product/product2.png')}}" alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
