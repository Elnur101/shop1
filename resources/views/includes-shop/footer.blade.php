            ...
            <div class="row main__footer--wrapper footer__top--row">
                <div class="col-lg-3 footer__col--width col-md-7 footer__col--padding footer__col--order">
                    <div class="footer__widget">
                        <h3 class="footer__widget--title sm__footer--widget__bock">About Us1
                        ...
                        <div class="footer__widget--inner">
                            <a class="footer__widget--logo" href="index.html"><img src="{{asset('/assets/img/logo/nav-log.png')}}" alt="footer-logo"></a>
                            <p class="footer__widget--desc m-0">The1 variety of products available at our store at the moment is vast, but we still continue to widen our assortment.</p>
                ...
                <div class="col-lg-2 footer__col--width col-md-4 footer__col--padding">
                    <div class="footer__widget">
                        <h3 class="footer__widget--title">Information1
                            <button class="footer__widget--button" aria-label="footer widget button">
                                <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                    <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                </svg>
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="about.html">About Us1</a></li>
                ...
                <div class="col-12 col-md-auto">
                    <div class="footer__payment">
                        <ul class="footer__payment--inner d-flex">
                            <li class="footer__payment--list"><img src="{{asset('/assets/img/other/payment1.png')}}" alt="payment-img"></li>
                            <li class="footer__payment--list"><img src="{{asset('/assets/img/other/payment2.png')}}" alt="payment-img"></li>
                            <li class="footer__payment--list"><img src="{{asset('/assets/img/other/payment3.png')}}" alt="payment-img"></li>
                            <li class="footer__payment--list"><img src="{{asset('/assets/img/other/payment4.png')}}" alt="payment-img"></li>
                            <li class="footer__payment--list"><img src="{{asset('/assets/img/other/payment5.png')}}" alt="payment-img"></li>
                        </ul>
                    </div>
                </div>
            </div>
